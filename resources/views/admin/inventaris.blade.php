            ...
            <table class="table dataTable table-bordered" id="myTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $inv->kondisi }}</td>
                        <td>
                            <button type="button" class="btn btn-sm btn-primary shadow" data-toggle="modal" data-target="#edit{{ $inv->id }}"><i class="fa fa-edit"></i></button>
                            <button type="button" class="btn btn-sm btn-danger shadow" data-toggle="modal" data-target="#hapus{{ $inv->id }}"><i class="fa fa-trash-alt"></i></button>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
...
<div class="modal fade" id="tambah" tabindex="-1" aria-hidden="true" id="staticBackdrop" data-backdrop="static" data-keyboard="false">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form class="form-horizontal" enctype="multipart/form-data" method="POST" action="{{ route('tambahinventaris') }}">
                @csrf
                <div class="row">
...
@foreach ($inventaris as $inv)
<!-- Modal ubah data-->
<div class="modal fade" id="edit{{ $inv->id }}" tabindex="-1" aria-hidden="true" id="staticBackdrop" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
        ...
        <div class="modal-body">
            <form class="form-horizontal" enctype="multipart/form-data" method="POST" action="{{ route('updateinventaris', $inv->id) }}">
                @csrf
                <div class="row">
                    <div class="form-group col-sm-12">
                        <label for="nama" >Nama</label>
                        <input type="text" class="form-control required" id="nama" name="nama" value="{{ $inv->nama }}"  minlength="2" required="">
                    </div>
                    <div class="form-group col-sm-12">
                        <label for="kode" >Kode</label>
                        <input type="text" class="form-control required" id="kode" name="kode" value="{{ $inv->kode }}"  minlength="2"  required="">
                    </div>
                    <div class="form-group col-sm-12">
                        <label for="jumlah" >Jumlah</label>
                        <input type="text" class="form-control required" id="jumlah" name="jumlah" value="{{ $inv->jumlah }}"  minlength="2" required="">
                    </div>
                    <div class="form-group col-sm-12">
                        <label for="kondisi" >Kondisi</label>
                        <select name="kondisi" id="kondisi" class="form-control">
...
<!-- modal hapus -->
<div class="modal fade" id="hapus{{ $inv->id }}" tabindex="-1" aria-hidden="true" id="staticBackdrop" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
